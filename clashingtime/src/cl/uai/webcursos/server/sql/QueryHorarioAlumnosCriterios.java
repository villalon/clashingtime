 ...
 *
 */
public class QueryHorarioAlumnosCriterios extends AbstractQueryHorario {
	 ...
	 */
	public QueryHorarioAlumnosCriterios(ClashingTimeImpl conn) throws AgendaException {
		super(conn);
	}

	@Override
	public String[][] executeQuery() throws AgendaException {
		this.sqlPrefix += "	inner join  [dbo].[Mena_InscripcionAlumnos] as i on " + 
